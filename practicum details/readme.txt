...
•	We have included PNG files of every screen as well as a Photoshop (.psd) file.  
•	We have included the plus/minus buttons as transparent PNG files, though it is also possible to create those using fonts.
•	We have included the font, Source Sans Pro, which is a Google web font
